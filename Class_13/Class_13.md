...
countData = countData[rowSums(countData, na.rm = TRUE, ) > 0, ]
head(countData)
```
...
![](Class_13_files/figure-gfm/unnamed-chunk-9-1.png)
...
![](Class_13_files/figure-gfm/unnamed-chunk-10-1.png)
...
```
    ...
    Info: Working in directory /Users/tahmid/Desktop/BIMM 143 Fall 2022/BIMM_143_github/Class_13
...
![](hsa04110.png) ![](hsa03030.png) ![](hsa03013.png) ![](hsa03440.png)
![](hsa04114.png)
...
Signaling by Rho GTPases, Miro GTPases and RHOBTB3 has the most
significant “Entities p-value” of 1.39E-5. No the pathways listed do not
match my previous KEGG results. The differences could be caused by our
KEGG using Log2 and LogAdj changes whereas reactome could have different
methods.
...
```
    ...
    other attached packages:
     ...
     [5] AnnotationDbi_1.60.0        DESeq2_1.38.1              
     [7] SummarizedExperiment_1.28.0 Biobase_2.58.0             
     [9] MatrixGenerics_1.10.0       matrixStats_0.63.0         
    [11] GenomicRanges_1.50.1        GenomeInfoDb_1.34.3        
    ...
    [28] ggplot2_3.4.0          cachem_1.0.6           cli_3.4.1             
    [31] magrittr_2.0.3         crayon_1.5.2           memoise_2.0.1         
    [34] evaluate_0.18          KEGGgraph_1.58.0       fansi_1.0.3           
    [37] graph_1.76.0           tools_4.2.2            lifecycle_1.0.3       
    [40] stringr_1.4.1          munsell_0.5.0          locfit_1.5-9.6        
    [43] DelayedArray_0.24.0    Biostrings_2.66.0      compiler_4.2.2        
    [46] rlang_1.0.6            grid_4.2.2             RCurl_1.98-1.9        
    [49] rstudioapi_0.14        bitops_1.0-7           rmarkdown_2.18        
    [52] gtable_0.3.1           codetools_0.2-18       DBI_1.1.3             
    [55] R6_2.5.1               knitr_1.41             dplyr_1.0.10          
    [58] fastmap_1.1.0          bit_4.0.5              utf8_1.2.2            
    [61] Rgraphviz_2.42.0       stringi_1.7.8          parallel_4.2.2        
    [64] Rcpp_1.0.9             vctrs_0.5.1            geneplotter_1.76.0    
    [67] png_0.1-7              tidyselect_1.2.0       xfun_0.35             
